...
const Services = () => {
  ...
  return (
    <div className="text-gray-200 h-full rounded-md rounded-l-none w-full max-w-4xl drop-shadow-lg shadow-black flex justify-center items-center">
      <div className="w-full bg-dark h-5/6 border-banano-yellow border-l-4">
        <div className="h-full overflow-y-scroll w-full bg-dark border-banano-yellow border-l-4">
